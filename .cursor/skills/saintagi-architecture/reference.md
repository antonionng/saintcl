# SaintAGI Architecture Reference

## Product Shape

SaintAGI is a control plane for managed OpenClaw runtimes.
...
- `openclaw-vendored/`: upstream snapshot with narrowly scoped SaintAGI patch areas.

## Ownership Heuristic

Use this routing rule before editing:

- If the change is about UI, billing surfaces, org settings, or product APIs, keep it in SaintAGI app code.
...
- Is the change SaintAGI-specific or truly runtime-native?
