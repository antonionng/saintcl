...
export const settingsTabs: Array<{
  ...
  },
  {
    ...
    description: "Productized channel bindings, connector setup, and tenant runtime requirements.",
    section: "operations",
  ...
  },
  {
    id: "security",
    label: "Security",
    description: "Repo allowlists, terminal policy, approval history, and rollout guardrails.",
    heading: "Security",
    section: "operations",
