...
export default async function StandaloneAutomationInAiFacilitatorPage() {
      ...
      <div className="mx-auto flex max-w-[1800px] flex-col gap-4">
        <div className="flex flex-wrap items-center justify-between gap-3 rounded-[1.5rem] border border-white/[0.08] bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.018))] px-5 py-4 shadow-[0_24px_80px_rgba(0,0,0,0.22)]">
          <div>
            ...
            <h1 className="mt-2 text-2xl font-semibold text-white">Automation in AI presenter console</h1>
        ...
        <AutomationInAiFacilitatorConsole cohortSnapshots={cohortSnapshots} />
      </div>
    </div>
  );
}
