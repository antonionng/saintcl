  ...
  const lines = [
    ...
    hasGateway && !isMinimal
      ? [
          ...
          "When calling config.patch, always pass a `raw` object string that contains the exact subtree to merge. Do not call config.patch with only an intent or a natural-language description.",
