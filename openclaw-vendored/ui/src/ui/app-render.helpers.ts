...
export function renderChatControls(state: AppViewState) {
  ...
  const showThinking = state.onboarding ? false : state.debugMode ? true : state.settings.chatShowThinking;
  const showToolCalls = state.onboarding ? true : state.debugMode ? true : state.settings.chatShowToolCalls;
